...
func BenchmarkLoadSymbols(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		for k, v := range core.NS {
			repl_env.Set(Symbol{k}, Func{v.(func([]MalType, *context.Context) (MalType, error)), nil})
		}
	}
}
...
func BenchmarkMAL1(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		repl_env.Set(Symbol{"eval"}, Func{func(a []MalType, ctx *context.Context) (MalType, error) {
